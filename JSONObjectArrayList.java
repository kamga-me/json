...
*/
public class JSONObjectArrayList<T extends JSONObject> extends JSONObjectList<T> {

	/**The class's serial version UID. */
	public static final long serialVersionUID = 0x0226F8F441B6928AL;
	...
	* Constructor.<br>
	*/
	public JSONObjectArrayList(int initialCapacity) {
	...
	* Constructor.<br>
	*/
	public JSONObjectArrayList() {
		this(0);
	}
	JSONObjectArrayList(T[] items) {
		this.items = items;
	...
	*/
	...
	public void add(final T item) {
		if (item == null) {
			...
			"JSONObjectArrayList::add-1: null item"
			);
		}
	...
	*/
	@Override
	public final boolean isJSONObjectArrayList() {
		return true; 
	}
	/**
	* {@inheritDoc}
	...
	*/
	@Override
	public final JSONObjectArrayList<T> asJSONObjectArrayList() {return this; }
	
	@SuppressWarnings("unchecked")
	protected T[] __getEmptyArray() {
		return (T[])JSONObject.EMPTY_ARRAY;
	}
	@SuppressWarnings("unchecked")
	protected T[] __newArray(int len) {
		return (T[])new JSONObject[len];
	}
	...
	protected class Iter implements core.IIterable<T> {
		...
		public int size() {
			return JSONObjectArrayList.this.size;
		}
